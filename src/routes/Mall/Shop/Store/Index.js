  ...
  export default class Index extends PureComponent {
      ...
      queryParamsFormater = (fields, type) => {
        ...
        const { data: { pagination } } = this.props.store;
      ...
      modalOkHandle = () => {
        this.modalForm.validateFields((err, fieldsValue) => {
          ...
          const fields = formaterObjectValue(params);
      ...
      renderTable = () => {
        ...
        const { data: { list, pagination } } = store;
      ...
      render() {
        ...
        const { store: { modalVisible, confirmLoading } } = this.props;
