  ...
  export default class Index extends PureComponent {
      ...
      queryParamsFormater = (fields, type) => {
        ...
        const { data: { pagination } } = this.props.test;
      ...
      renderTable = () => {
        ...
        const { data: { list, pagination } } = test;
      ...
      render() {
        ...
        const { test: { modalVisible, confirmLoading } } = this.props;
